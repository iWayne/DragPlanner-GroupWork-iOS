...
//        timeLabel2.hidden = false
    ...
    @IBAction func shareFunc(sender: AnyObject) {
        ...
        var activity:UIActivityViewController = UIActivityViewController(activityItems: items, applicationActivities: activities as [AnyObject])
